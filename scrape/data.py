...
def connect_to_mongo():
    ...
    return client["Product_data"]  # Use correct case
...
def extract_amazon_products(page, query):
    ...
    for i in range(count):
        try:
            ...
            # 🔽 NEW: Get reviews (usually next to rating)
...
def insert_data(data, platform):
    ...
    for record in data:
        ...
        existing = collection.find_one({
            "Links": record["Links"],  # More reliable than product name
